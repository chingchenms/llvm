...
!6 = distinct !DISubprogram(name: "f", scope: !7, file: !7, line: 55, type: !8, isLocal: false, isDefinition: true, scopeLine: 55, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
...
; CHECK-LABEL: distinct !DISubprogram(name: "f", scope:
; CHECK: !DILocalVariable(name: "x", arg: 1
; CHECK: !DILocalVariable(name: "coro_hdl", scope:

; CHECK-LABEL: distinct !DISubprogram(name: "f", linkageName: "f.resume"
; CHECK: distinct !DILocalVariable(name: "x", arg: 1
; CHECK-NOT: distinct !DILocalVariable(name: "x", arg: 1

; CHECK-LABEL: distinct !DISubprogram(name: "f", linkageName: "f.destroy"
; CHECK: distinct !DILocalVariable(name: "coro_hdl"
; CHECK-NOT: distinct !DILocalVariable(name: "coro_hdl"

; CHECK-LABEL: distinct !DISubprogram(name: "f", linkageName: "f.cleanup"
