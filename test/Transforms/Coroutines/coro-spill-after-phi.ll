...
;  %val1 = call i32 @print(i32 0)
;  %val2 = call i32 @print(i32 0)
  br i1 %n, label %begin, label %alt
alt:
;  %val3 = call i32 @print(i32 1)
;  %val4 = call i32 @print(i32 1)
  br label %begin

begin:
;  %phi1 = phi i32 [ %val1, %entry ], [ %val3, %alt ]
;  %phi2 = phi i32 [ %val2, %entry ], [ %val4, %alt ]
